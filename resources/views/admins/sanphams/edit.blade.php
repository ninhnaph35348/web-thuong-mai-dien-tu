                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            @error('ma_san_pham') is-invalid @enderror"
                                                value="{{ $sanPham->ma_san_pham }}" placeholder="Tên danh mục">
                                            @error('ma_san_pham')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @error('ngay_nhap') is-invalid @enderror"
                                                value="{{ $sanPham->ngay_nhap }}" placeholder="Số lượng sản phẩm">
                                            @error('ngay_nhap')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @error('mo_ta_ngan') is-invalid @enderror"
                                                rows="3" placeholder="Mô tả ngắn">{{ $sanPham->mo_ta_ngan }}</textarea>
