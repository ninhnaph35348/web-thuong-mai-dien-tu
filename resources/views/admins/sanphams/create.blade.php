                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                            ...
                                            <select name="danh_muc_id" id="danh_muc_id"
                                                ...
                                                @foreach ($listDanhMuc as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ old('gia_khuyen_mai') == $item->id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control " name="mo_ta_ngan" id="mo_ta_ngan" rows="3" placeholder="Mô Tả Ngắn"
                                        ...
                                        <div class="d-flex justify-content-between ps-3 form-switch mb-2">
                                            <div class="form-check ">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-check-label" for="is_hot_deal">Mô Tả Chi Tiết Sản
                                                Phẩm</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('add-row').addEventListener('click', function() {
                ...
                var tableBody = document.getElementById('image-table-boby')
